...
public class BossProjectile : MonoBehaviour {
    ...
    public void OnTriggerEnter(Collider other){
        if (other.tag == "Player"){
            ...
            GameObject b = Instantiate(AcidPool, new Vector3(other.transform.position.x, transform.position.y, other.transform.position.z), other.transform.rotation);
            Destroy(a, 0.5f);
            Destroy(b, 2.8f);
        }
    }
